...
System.register(['angular2/core', 'angular2/platform/browser', 'angular2/http'], function(exports_1) {
    ...
    var core_1, browser_1, http_1, http_2;
    var child, parent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            ...
            parent = (function () {
                ...
                parent.prototype.addtask = function (task, detail) {
                    ...
                    this.http.post('http://localhost:3000/addtaskserver', JSON.stringify(obj), requestOption)
                        ...
                        console.log(res.json());
                        //ye display kiyo nai horha, fromserver variable
            ...
            browser_1.bootstrap(parent, [http_2.HTTP_PROVIDERS]);
        }
    }
});
