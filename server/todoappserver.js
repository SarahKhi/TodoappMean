...
var bodyparser = require('body-parser'); //for collecting data direct from client
var server = express();
server.listen(3000);
var path = require('path');
//var tasks;
//var details;
//the database collection/ schema would have task id and detail
//i will create schema and database a collection that would have multiple documents/record
//when ever there button click i will post data in collection as well and will
//show that from collection all the documents
